...
let givProduct = document.querySelector('.products');
let givBtn =document.querySelectorAll('button');
givBtn.forEach(function(element) {
...
function showCategory(category) {
   ...
   givProduct.insertAdjacentHTML('beforeend', getProductMarkup(i));
   }
}
